...
class ModefiyUserDataViewBody extends StatefulWidget {
  ...
  @override
  State<ModefiyUserDataViewBody> createState() =>
      _ModefiyUserDataViewBodyState();
}

class _ModefiyUserDataViewBodyState extends State<ModefiyUserDataViewBody> {
  ...
  @override
  void initState() {
    userCountry = widget.userData.country ?? "";
    birthDate = widget.userData.birthdate ?? "";
    userImage = widget.userData.userPhoto ?? "";
    // TODO: implement initState
    nameControler = TextEditingController(text: widget.userData.userName);
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () async {
                ...
                BlocProvider.of<UpdateUserdataCubit>(context).updateUserData(
                    UserModel(
              ...
              child: Text(
                ...
                style: TextStyle(
                    ...
                    color: (widget.userData.userName == nameControler.text &&
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text(
                      "${widget.userData.userName!.length}/30",
                ...
                const SizedBox(height: 6),
                Container(
                    constraints: BoxConstraints(minHeight: screenHieght * 0.2),
                    width: screenWidth,
                    padding: const EdgeInsets.symmetric(
                        horizontal: 12, vertical: 15),
                    decoration: BoxDecoration(
