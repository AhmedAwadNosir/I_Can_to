...
class CompleteAndStorUserDataViewBody extends StatefulWidget {
  const CompleteAndStorUserDataViewBody(
      {super.key, required this.userId, required this.credential});
  static const id = "CompleteAndStorUserData";
  final String userId;
  final UserCredential credential;
  @override
  State<CompleteAndStorUserDataViewBody> createState() =>
      _CompleteAndStorUserDataViewBodyState();
}

class _CompleteAndStorUserDataViewBodyState
    extends State<CompleteAndStorUserDataViewBody> {
                          ...
                          child: ElevatedButton(
                              onPressed: () async {
                                ...
                                if (birthdate != "00-00-00") {
                                  final userData = widget.credential.user;
                                  BlocProvider.of<StoreUserDataCubit>(context)
                                      .storeUserDatac(
